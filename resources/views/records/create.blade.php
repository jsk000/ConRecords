...
@section('content')
    ...
    <h4 class="card-header"> Create a Record for {{ $project->p_name }}</h4>

    <div class="card-body">

        <form method="POST" action="{{ route('projects.records.store', $project) }}" enctype="multipart/form-data">
            @csrf

            <div class="row mb-3">
                <label for="r_reference" class="col-md-2 col-form-label text-md-start">{{ __('Record Reference') }}</label>
                <div class="col-md-6">
                    <input id="r_reference" type="text" class="form-control" name="r_reference" value="{{ old('r_reference', $r_ref) }}" required autocomplete="on">
                </div>
            </div>
            ...
            <div class="row mb-3">
                <div class="col-md-4">
                    ...
                    <input id="date" type="date" class="form-control" name="date" value="{{ old('date') }}" required autocomplete="off">
                </div>
                <div class="col-md-4">
                    <label for="time" class="col-form-label text-md-start">{{ __('Time') }}</label>
                    <input id="time" type="time" class="form-control" name="time" value="{{ old('time') }}" required autocomplete="off">
                </div>
            </div>
            ...
            <div class="row mb-3">
                <div class="col-md-4">
                    ...
                    <input id="weather" type="text" class="form-control" name="weather" value="{{ old('weather') }}" required autocomplete="on">
                </div>
                <div class="col-md-4">
                    <label for="temperature" class="col-form-label text-md-start">{{ __('Temperature') }}</label>
                    <input id="temperature" type="number" class="form-control" name="temperature" value="{{ old('temperature') }}" required autocomplete="on">
                </div>
            </div>
            ...
            <div id="workers-container">
                <!-- Worker fields will be added here -->
            </div>

            <div class="row mb-3">
                <label for="performed_services" class="col-md-2 col-form-label text-md-start">{{ __('Performed Services') }}</label>
                <div class="col-md-6">
                    <textarea id="performed_services" type="text" class="form-control" name="performed_services" required autocomplete="on">{{ old('performed_services') }}</textarea>
                </div>
            </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-6">
                    <textarea id="equipments_materials" type="text" class="form-control" name="equipments_materials" required autocomplete="on">{{ old('equipments_materials') }}</textarea>
                </div>
            </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-6">
                    <textarea id="other_involved_party" type="text" class="form-control" name="other_involved_party" autocomplete="on">{{ old('other_involved_party') }}</textarea>
                </div>
            </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-6">
                    <textarea id="other_events" type="text" class="form-control" name="other_events">{{ old('other_events') }}</textarea>
                </div>
            </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-6">
                    <textarea id="notes" class="form-control" name="notes" rows="4">{{ old('notes') }}</textarea>
                </div>
            </div>
